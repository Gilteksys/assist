    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if cliente is not None:
                return JsonResponse({'success': False, 'message': 'Cliente com o mesmo nome já existe'})

            cliente = Cliente.objects.create(nome=nome, contato=contato, endereco=endereco, observacao=observacao)
            return JsonResponse({'success': True, 'message': 'Cliente criado com sucesso', 'cliente_id': cliente.id, 'enable_nova_ordem': True})
